...
impl BuiltinMethod {
    pub fn from_name(name: &str) -> Self {
        ...
        match name {
            ...
            "to_pairs" => Self::ToPairs,
            "from_pairs" => Self::FromPairs,
            "invert" => Self::Invert,
            ...
            "any" | "exists" => Self::Any,
            "all" => Self::All,
            "find_index" => Self::FindIndex,
            "indices_where" => Self::IndicesWhere,
            "max_by" => Self::MaxBy,
            "min_by" => Self::MinBy,
            "group_by" => Self::GroupBy,
            "count_by" => Self::CountBy,
            "index_by" => Self::IndexBy,
            "group_shape" => Self::GroupShape,
            ...
            "sort" | "sort_by" => Self::Sort,
            "unique" | "distinct" => Self::Unique,
            "unique_by" => Self::UniqueBy,
            "collect" => Self::Collect,
            "deep_find" => Self::DeepFind,
            "deep_shape" => Self::DeepShape,
            "deep_like" => Self::DeepLike,
            "walk" => Self::Walk,
            "walk_pre" => Self::WalkPre,
            "rec" => Self::Rec,
            "trace_path" => Self::TracePath,
            "flatten" => Self::Flatten,
            "compact" => Self::Compact,
            "join" => Self::Join,
            "equi_join" => Self::EquiJoin,
            "first" => Self::First,
            "last" => Self::Last,
            "nth" => Self::Nth,
            "take" => Self::Take,
            ...
            "find_one" => Self::FindOne,
            "approx_count_distinct" => Self::ApproxCountDistinct,
            "accumulate" => Self::Accumulate,
            "partition" => Self::Partition,
            "zip" => Self::Zip,
            "zip_longest" => Self::ZipLongest,
            "fanout" => Self::Fanout,
            "zip_shape" => Self::ZipShape,
            "pick" => Self::Pick,
            "omit" => Self::Omit,
            "merge" => Self::Merge,
            "deep_merge" => Self::DeepMerge,
            "defaults" => Self::Defaults,
            "rename" => Self::Rename,
            "transform_keys" => Self::TransformKeys,
            "transform_values" => Self::TransformValues,
            "filter_keys" => Self::FilterKeys,
            "filter_values" => Self::FilterValues,
            "pivot" => Self::Pivot,
            "get_path" => Self::GetPath,
            "set_path" => Self::SetPath,
            "del_path" => Self::DelPath,
            "del_paths" => Self::DelPaths,
            "has_path" => Self::HasPath,
            "flatten_keys" => Self::FlattenKeys,
            "unflatten_keys" => Self::UnflattenKeys,
            "to_csv" => Self::ToCsv,
            "to_tsv" => Self::ToTsv,
            "or" => Self::Or,
            "has" => Self::Has,
            ...
            "rolling_avg" => Self::RollingAvg,
            "rolling_min" => Self::RollingMin,
            "rolling_max" => Self::RollingMax,
            "lag" => Self::Lag,
            "lead" => Self::Lead,
            "diff_window" => Self::DiffWindow,
            "pct_change" => Self::PctChange,
            "cummax" => Self::CumMax,
            "cummin" => Self::CumMin,
            "zscore" => Self::Zscore,
            "upper" => Self::Upper,
            ...
            "trim" => Self::Trim,
            "trim_left" | "lstrip" => Self::TrimLeft,
            "trim_right" | "rstrip" => Self::TrimRight,
            "snake_case" => Self::SnakeCase,
            "kebab_case" => Self::KebabCase,
            "camel_case" => Self::CamelCase,
            "pascal_case" => Self::PascalCase,
            "reverse_str" => Self::ReverseStr,
            "lines" => Self::Lines,
            "words" => Self::Words,
            "chars" => Self::Chars,
            "chars_of" => Self::CharsOf,
            "bytes" => Self::Bytes,
            "byte_len" => Self::ByteLen,
            "is_blank" => Self::IsBlank,
            ...
            "parse_bool" => Self::ParseBool,
            "to_base64" => Self::ToBase64,
            "from_base64" => Self::FromBase64,
            "url_encode" => Self::UrlEncode,
            "url_decode" => Self::UrlDecode,
            "html_escape" => Self::HtmlEscape,
            "html_unescape" => Self::HtmlUnescape,
            "repeat" | "repeat_str" => Self::Repeat,
            ...
            "scan" => Self::Scan,
            "re_match" => Self::ReMatch,
            "match_first" => Self::ReMatchFirst,
            "match_all" => Self::ReMatchAll,
            "captures" => Self::ReCaptures,
            "captures_all" => Self::ReCapturesAll,
            "split_re" => Self::ReSplit,
            "replace_re" => Self::ReReplace,
            "replace_all_re" => Self::ReReplaceAll,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum BuiltinPipelineDemand {
    Filter,
    Map,
    FlatMap,
    Take,
...
impl BuiltinSpec {
    ...
    fn pipeline_demand(mut self, demand: BuiltinPipelineDemand) -> Self {
        self.pipeline_demand = Some(demand);
        self
    }
...
mod spec_tests {
    ...
    #[test]
    fn builtin_specs_drive_pipeline_demand_and_order_metadata() {
        assert_eq!(
            BuiltinMethod::Filter.spec().pipeline_demand,
            Some(BuiltinPipelineDemand::Filter)
        );
        assert_eq!(
            BuiltinMethod::Map.spec().pipeline_demand,
            Some(BuiltinPipelineDemand::Map)
        );
        assert_eq!(
            BuiltinMethod::Take.spec().pipeline_demand,
            Some(BuiltinPipelineDemand::Take)
        );
        assert_eq!(
            BuiltinMethod::Split.spec().pipeline_demand,
            Some(BuiltinPipelineDemand::FlatMap)
        );
        assert_eq!(
            BuiltinMethod::Filter.spec().pipeline_order_effect,
